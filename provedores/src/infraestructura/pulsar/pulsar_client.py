"""
Cliente de Apache Pulsar para el microservicio de proveedores
"""
import json
import os
import logging
...
class PulsarClient:
    """Cliente de Pulsar para el microservicio de proveedores."""
    ...
    def connect(self) -> None:
        ...
        try:
            ...
            logger.info(f"Cliente de proveedores conectado a Pulsar en {self.service_url}")
    ...
    def disconnect(self) -> None:
        ...
        try:
            ...
            logger.info("Cliente de proveedores desconectado de Pulsar")
        except Exception as e:
