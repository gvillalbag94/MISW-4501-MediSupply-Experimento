...
def create_application():
    ...
    try:
        ...
        logger.info("Microservicio de Provedores initialized successfully")
        return app
        
    except Exception as e:
        logger.error(f"Failed to initialize Microservicio de Provedores: {str(e)}")
        raise
