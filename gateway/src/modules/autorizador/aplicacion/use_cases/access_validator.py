...
class AccessValidator:
    ...
    def __init__(self):
        # Mapeo de rutas a recursos y acciones
        self.route_permissions: Dict[str, Dict[str, Tuple[ResourceType, ActionType]]] = {
            ...
            "/users": {
                "GET": (ResourceType.USERS, ActionType.READ),
                "POST": (ResourceType.USERS, ActionType.CREATE),
                "PUT": (ResourceType.USERS, ActionType.UPDATE),
                "DELETE": (ResourceType.USERS, ActionType.DELETE)
            },
            "/health": {
                "GET": (ResourceType.HEALTH, ActionType.READ)
            }
        }
